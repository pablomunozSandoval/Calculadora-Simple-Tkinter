...
btnSuma=Button(miFrame,text="+",width=3,command=lambda:numPulsado("+"))
...
btnResta=Button(miFrame,text="-",width=3,command=lambda:numPulsado("-"))
btnResta.grid(row=3,column=4)
#------------Fila3
btn7=Button(miFrame,text="7",width=3,command=lambda:numPulsado("7"))
...
#------------Fila4
btnIgual=Button(miFrame,text="=",width=3,command=lambda:numPulsado("="))
